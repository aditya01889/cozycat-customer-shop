...
export default function ProductFiltersEnhanced({ categories, selectedCategory }: ProductFiltersEnhancedProps) {
  ...
  return (
    <>
      ...
      {/* Horizontal Category Pills - Mobile First */}
        ...
        <div className="relative">
          ...
          {canScrollLeft && (
            <button
              ...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-white shadow-md rounded-full p-2 -ml-3"
            >
          ...
          {canScrollRight && (
            <button
              ...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-white shadow-md rounded-full p-2 -mr-3"
            >
          ...
          <div
            ...
            className="flex gap-2 overflow-x-auto scrollbar-hide scroll-smooth px-2 py-1"
