...
// Import and run the basic performance test
const basicTest = require('./basic-performance-test.js');

// Set command line arguments to trigger the test
process.argv[2] = 'run';

// Call the main function directly by accessing it from the module
const mainFunction = basicTest.__esModule ? basicTest.default.main : basicTest.main;
if (mainFunction) {
  mainFunction();
} else {
  console.log('❌ Could not find main function in basic-performance-test.js');
}
